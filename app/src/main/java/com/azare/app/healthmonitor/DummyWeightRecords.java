...
public class DummyWeightRecords implements IDummyReading {
    ...
    public DummyWeightRecords() {
        ...
        mapDateWeight.put("15/09/2018 15:10:30", 77);
        mapDateWeight.put("13/10/2018 17:00:20", 77);
        mapDateWeight.put("14/11/2018 09:30:50", 77);
        mapDateWeight.put("16/12/2018 10:15:00", 77);
    }
