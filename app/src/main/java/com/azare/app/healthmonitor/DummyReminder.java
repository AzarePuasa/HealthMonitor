...
public class DummyReminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dummy_reminder);
        ...
        Intent alarmIntent = new Intent(DummyReminder.this, AlarmReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(DummyReminder.this, ALARM_REQUEST_CODE, alarmIntent, 0);
        ...
        findViewById(R.id.start_alarm_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.e(HMUtils.LOGTAG, "Fail to pause application");
                }
    ...
    public void stopAlarmManager() {
        ...
        stopService(new Intent(DummyReminder.this, AlarmSoundService.class));
